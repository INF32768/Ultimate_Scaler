...
public final class UltimateScalerOptions {
    ...
    public static void saveConfig() throws IOException {
        ...
        ConfigManager.writeEntry(CONFIG_PATH, "simulateEndRings", config.simulateEndRings, new String[] {Text.translatable("ultimate_scaler.options.worldgen.simulateEndRings").getString(), Text.translatable("ultimate_scaler.options.worldgen.simulateEndRings.tooltip").getString()});
