...
public abstract class MixinShiftA implements DensityFunctionTypes.Offset {
    ...
    public double sample(NoisePos pos) {
        return this.sample((double)pos.blockX() * config.globalXScale + config.globalXOffset, (double)0.0F, (double)pos.blockZ() * config.globalZScale + config.globalZOffset) * (double)4.0F;
    }
}
